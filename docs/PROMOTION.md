...
**Status:** Published — `@kensaurus/cursor-kenji@1.37.0` via OIDC run [35825584279](https://github.com/kensaurus/cursor-kenji/actions/runs/35825584279) (Claude Opus 5.5 pass: effort routing, rule re-baseline, dated-pattern cleanup). Previous: `1.36.3` via OIDC run [35725729170](https://github.com/kensaurus/cursor-kenji/actions/runs/35725729170).
