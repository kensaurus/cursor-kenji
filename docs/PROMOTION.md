...
**Status:** [x] Published — `@kensaurus/cursor-kenji@1.34.0` via OIDC run [34699131914](https://github.com/kensaurus/cursor-kenji/actions/runs/34699131914); `npm view … version` returns `1.34.0` and `dist-tags.latest` is `1.34.0` (2026-09-12)
