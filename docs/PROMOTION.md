...
**PR copy:**
```markdown
- [cursor-kenji](https://github.com/kensaurus/cursor-kenji) — ready-made AI playbooks your editor auto-triggers: 115 agent skills,
  39 slash commands, 6 subagents, and MCP configs for React/Next.js/Supabase development.
  `npx skills add kensaurus/cursor-kenji`
```
...
> 115 Cursor agent skills for React/Next.js/Supabase — installs in one command.
...
3. What's in cursor-kenji (115 skills, 39 commands, 6 subagents)
