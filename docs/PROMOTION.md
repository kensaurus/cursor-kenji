...
**PR copy:**
```markdown
- [cursor-kenji](https://github.com/kensaurus/cursor-kenji) — ready-made AI playbooks your editor auto-triggers: 107 agent skills,
...
> 107 Cursor agent skills for React/Next.js/Supabase — installs in one command.
...
3. What's in cursor-kenji (107 skills, 36 commands, 6 subagents)
