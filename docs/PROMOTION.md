...
**PR copy:**
```markdown
- [cursor-kenji](https://github.com/kensaurus/cursor-kenji) — ready-made AI playbooks your editor auto-triggers: 136 agent skills,
...
> 136 Cursor agent skills for React/Next.js/Supabase — installs in one command.
...
One install, 136 skills auto-activate:
npx skills add kensaurus/cursor-kenji
...
```
Title: 136 Cursor AI Skills That Match on Keywords

1. The problem: writing the same prompts over and over
2. What Cursor skills are and how they work
3. What's in cursor-kenji (136 skills, 50 commands, 6 subagents)
