...
**Status:** [ ] Pending — `@kensaurus/cursor-kenji@1.35.0` not on the registry yet; the GitHub Release that triggers the OIDC workflow has not been created. Registry serves 1.34.0.
