...
**Status:** [ ] Pending — `@kensaurus/cursor-kenji@1.33.0` is not on the registry yet; the GitHub Release that triggers the OIDC workflow has not been created. Registry currently serves 1.32.0.
