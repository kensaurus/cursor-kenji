...
**PR copy:**
```markdown
- [cursor-kenji](https://github.com/kensaurus/cursor-kenji) — ready-made AI playbooks your editor auto-triggers: 128 agent skills,
  43 slash commands, 6 subagents, and MCP configs for React/Next.js/Supabase development.
  `npx skills add kensaurus/cursor-kenji`
```
...
> 128 Cursor agent skills for React/Next.js/Supabase — installs in one command.
...
3. What's in cursor-kenji (128 skills, 43 commands, 6 subagents)
