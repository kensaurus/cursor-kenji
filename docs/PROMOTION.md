...
**Status:** [ ] Pending — `@kensaurus/cursor-kenji@1.36.1` not on the registry yet; the GitHub Release that triggers the OIDC workflow has not been created. Registry serves 1.36.0.
