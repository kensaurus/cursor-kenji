...
**Status:** [ ] 1.32.0 pending — tag `v1.32.0` pushed, GitHub Release not yet created, so the OIDC workflow has not fired. `npm view` still returns 1.31.0. Last verified publish: `@kensaurus/cursor-kenji@1.31.0`.
