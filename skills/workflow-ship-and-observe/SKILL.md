...
description: >
  Take merged, green code to a verified, monitored production release. Use
  when "ship it", "deploy to production", "release this", "go live", "roll
  this out", "promote to prod", or "cut a release" for a running app (npm
  packages → deploy-npm).
license: MIT
---
