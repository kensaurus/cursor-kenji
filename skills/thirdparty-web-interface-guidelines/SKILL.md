...
description: >-
  Third-party skill — reviews UI code for Vercel Web Interface Guidelines compliance
  (accessibility, focus, forms, animation, performance, copy). Use when auditing
  interfaces, reviewing UI PRs, or when the user mentions Vercel guidelines,
  web interface guidelines, or /thirdparty-web-interface-guidelines.
---

# Web Interface Guidelines

> **Third-party skill** (upstream-maintained). See [ATTRIBUTION.md](ATTRIBUTION.md).  
> Upstream: [vercel-labs/web-interface-guidelines](https://github.com/vercel-labs/web-interface-guidelines) · [vercel.com/design/guidelines](https://vercel.com/design/guidelines) · Local name: `thirdparty-web-interface-guidelines`
