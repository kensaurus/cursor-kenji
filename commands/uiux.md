...
- **`enhance-web-ui`** at `~/.cursor/skills/enhance-web-ui/SKILL.md` — cosmetic polish, hierarchy, spacing, vague-but-visceral feedback.
- **`enhance-web-ux`** at `~/.cursor/skills/enhance-web-ux/SKILL.md` — replace generic AI-templated UI with semantic data.
